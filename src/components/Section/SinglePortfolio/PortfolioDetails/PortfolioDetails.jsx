      ...
      <div className="container">
        ...
        <div className="zubuz-portfolio-info">
          ...
          <div className="zubuz-portfolio-info-item">
            ...
            <Link href="">
              <h3>
                Live preview <Image src="/images/icon/arrow-right.svg" alt="" />
              </h3>
            </Link>
          </div>
        </div>
          ...
          <div className="col-lg-4">
            <div className="zubuz-portfolio-details-thumb-wrap">
              <div className="zubuz-portfolio-details-thumb-item">
                <Image src="/images/portfolio/p-details1.png" alt="" />
              </div>
              <div className="zubuz-portfolio-details-thumb-item">
                <Image src="/images/portfolio/p-details2.png" alt="" />
              </div>
              <div className="zubuz-portfolio-details-thumb-item">
                <Image src="/images/portfolio/p-details3.png" alt="" />
              </div>
            </div>
          </div>
        </div>
