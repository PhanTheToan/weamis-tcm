          ...
          <div className="col-lg-8">
            <div className="single-post-content-wrap">
              <div className="post-thumbnail">
                <Image src="/images/blog/blog5.png" alt="" />
              </div>
                ...
                <div className="post-comment">
                  ...
                  <ul>
                    <li>
                      <div className="post-comment-wrap">
                        <div className="post-comment-thumb">
                          <Image src="/images/team/team1.png" alt="" />
                        </div>
                    ...
                    <li className="children">
                      <div className="post-comment-wrap">
                        <div className="post-comment-thumb">
                          <Image src="/images/team/team2.png" alt="" />
                        </div>
                        <div className="post-comment-data">
                          <Link className="comment-reply" href="">
                            Reply
                    ...
                    <li>
                      <div className="post-comment-wrap">
                        <div className="post-comment-thumb">
                          <Image src="/images/team/team3.png" alt="" />
                        </div>
                        <div className="post-comment-data">
                          <Link className="comment-reply" href="">
                            Reply
              ...
              <div className="widget zubuz_recent_posts_Widget">
                ...
                <div className="post-item">
                  <div className="post-thumb">
                    <Link href="">
                      <Image src="/images/blog/blog1.png" alt="" />
                    </Link>
                  </div>
                ...
                <div className="post-item">
                  <div className="post-thumb">
                    <a href="">
                      <Image src="/images/blog/blog2.png" alt="" />
                    </a>
                  </div>
                  <div className="post-text">
                    <div className="post-date">June 18, 2024</div>
                ...
                <div className="post-item">
                  <div className="post-thumb">
                    <Link href="">
                      <Image src="/images/blog/blog3.png" alt="" />
                    </Link>
                  </div>
                  <div className="post-text">
                    <div className="post-date">June 18, 2024</div>
