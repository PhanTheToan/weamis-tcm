...
import PortfolioFilterNav from "../Components/PortfolioFilterNav-service";
    ...
    <div className="section zubuz-section-padding3 overflow-hidden">
      <div className="container">
        <div className="zubuz-section-title center">
          <h2>Khám phá các dự án dịch vụ của Weamis</h2>
        </div>
        <PortfolioFilterNav
          filterKey={filterKey}
        ...
        >
          <div className="filter-item wifi landingpage website">
          ...
          <div className="filter-item wifi branding chuyendoiso landingpage saas ecommerce">
          ...
          <div className="filter-item wifi  chuyendoiso landingpage website">
          ...
          <div className="filter-item wifi branding landingpage ecommerce">
